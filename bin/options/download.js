...
const downloadURLS = {
    windows: [
        ...
        {
            url: `https://cdn.altv.mp/coreclr-module/release/x64_linux/AltV.Net.Host.dll`,
            destination: '.'
        },
        {
            url: `https://cdn.altv.mp/coreclr-module/release/x64_linux/AltV.Net.Host.runtimeconfig.json`,
            destination: '.'
        },
        {
            url: 'https://cdn.altv.mp/coreclr-module/release/x64_win32/modules/csharp-module.dll',
            destination: './modules'
        }
    ],
    linux: [
        ...
        {
            url: 'https://cdn.altv.mp/coreclr-module/release/x64_linux/modules/libcsharp-module.so',
            destination: './modules'
        }
    ],
};
